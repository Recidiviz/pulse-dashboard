...
const ExitsChart = ({
  ...
  const chart = (
    <Bar
      ...
      data={{
        ...
        datasets: [
          {
            label: "Percent revoked of exits",
      ...
      options={{
        annotation: getAverageRateAnnotation(averageRate),
        legend: {
          display: false,
        },
        responsive: true,
          ...
          yAxes: [
            {
              ...
              scaleLabel: {
                display: true,
                labelString: "Percent revoked of exits",
              },
              stacked: true,
              ticks: {
  ...
  return (
    <div>
      ...
      <ModeSwitcher mode="exits" setMode={setMode} />
      <div className="static-chart-container fs-block">{chart}</div>
    </div>
  );
};

ExitsChart.propTypes = {
