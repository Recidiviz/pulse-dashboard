...
export const US_PA_METHODOLOGY = {
  ...
  recommitmentsMatrix: [
    ...
    },
    {
      ...
      body: `This is determined by counting the total number of reports that were filed one year prior to the last reported violation before their admission. For example, if a person had one violation report on February 10, 2016, and one violation report  on February 1, 2017, and then they were recommitted (without any new violations), they would be in the "2" column. This is the case even if several types of violations or conditions violated were listed within a single report.`,
    },
    {
      id: 4,
      header: "Who is included",
  ...
  recommitmentsBySubOffice: [
    ...
    },
    {
      ...
      body: `When no violation history filters are selected in the "Recommitments by violation history" plot, this chart shows the admission rate from parole in each sub-office. Admission rate is defined as the number of people recommitted from that sub-office in the selected time period divided by the total supervised population within that sub-office during the same time period. The sub-offices are positioned in descending order from left to right, with the sub-office with the highest admission rate at the left. If a person's sub-office is unknown (meaning they were not under active supervision within two years prior to their admission), they are not included in the sub-office counts or rates. When hovering over any sub-office column, users can see the total number of people on supervision in that sub-office as the denominator and the total number of people recommitted in that sub-office as the numerator.`,
    },
    {
      id: 3,
      header: "Who is included",
